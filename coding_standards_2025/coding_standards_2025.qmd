...
This will be a brief overview and includes some resources you can use to learn more.
...
-   Therefore easier to collaborate with others.
-   Easier for reviewers to understand and provide insightful feedback.
-   It improves the reproducibility and reusability of code.
...
## General suggestion: Be consistent

If not specified in your organisation, decide upon your (team's) standards and apply them consistently to your projects.

For example:

-   Project directory structure and file naming conventions.
-   Code style and linting checks that should pass.
-   How code is commented and documented.
-   Packages used.
-   How code is tested before being used in a production process.
